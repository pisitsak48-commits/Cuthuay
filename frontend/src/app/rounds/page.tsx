                ...
                <tbody>
                  {visibleRounds.map((round, i) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-theme-text-secondary tabular-nums tracking-tight text-xs">
                        {new Date(round.draw_date).toLocaleDateString('th-TH')}
                      </td>
                      <td className="py-3 px-4 tabular-nums tracking-tight text-theme-text-secondary">
                        {(round.bet_count ?? 0).toLocaleString()}
                      </td>
                      <td className="py-3 px-4 tabular-nums tracking-tight text-profit">
