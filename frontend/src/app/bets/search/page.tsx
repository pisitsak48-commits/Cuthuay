          ...
          >
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-20 bg-surface-200 border border-border text-theme-text-primary text-sm rounded px-2 py-1 text-right focus:outline-none focus:border-[var(--color-accent)]"
              />
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-24 bg-surface-200 border border-border text-theme-text-primary text-sm rounded px-2 py-1 text-right focus:outline-none focus:border-[var(--color-accent)]"
              />
