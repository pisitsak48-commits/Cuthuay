    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--color-backdrop-overlay)] p-4">
      <motion.div
        ...
        <div className="space-y-3 px-6 py-5">
          {opts.map((o) => (
            <label key={o.k} className={`flex flex-col gap-2 rounded-xl border-2 p-3.5 cursor-pointer transition-[background-color,border-color,box-shadow] duration-200 ease-out ${
              mode === o.k
              ...
              <div className="flex items-center gap-2.5">
                <input type="radio" name="cut-search-mode" className="h-4 w-4 accent-[var(--chart-primary)]" checked={mode === o.k} onChange={() => setMode(o.k)} />
