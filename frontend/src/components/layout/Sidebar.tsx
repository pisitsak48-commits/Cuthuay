    ...
    >
      ...
      >
        ...
        <button
          ...
          className={cn(
            'hidden md:flex rounded-full border border-[var(--color-border)] bg-[var(--color-input-bg)] p-2 text-[var(--color-nav-inactive)] hover:text-accent hover:border-accent/30 transition-colors duration-theme shrink-0 items-center justify-center',
            !expanded && 'mx-auto',
          )}
        >
        ...
        <button
          ...
          onClick={() => setSidebarMobileOpen(false)}
          aria-label="ปิดเมนู"
          className="md:hidden flex rounded-full border border-[var(--color-border)] bg-[var(--color-input-bg)] p-2 text-[var(--color-nav-inactive)] hover:text-accent hover:border-accent/30 transition-colors duration-theme shrink-0 items-center justify-center"
        >
          <CloseIcon />
        </button>
      </div>
